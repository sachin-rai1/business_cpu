...
class PurchaseReviewedView extends GetView<PurchaseReviewedController> {
   PurchaseReviewedView({Key? key}) : super(key: key);
 final PurchaseReviewedController purchaseReviewedController = Get.put(PurchaseReviewedController());
  @override
