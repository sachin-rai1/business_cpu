...
class PurchasePendingView extends GetView<PurchasePendingController> {
  PurchasePendingView({Key? key}) : super(key: key);

  final PurchasePendingController pendingController =
      Get.put(PurchasePendingController());
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: Padding(
        ...
        child: Column(
          ...
          children: [
            TextFormWidget(
                dropDownItems: controller.dropDownStatus.map((selectedType) {
  ...
  void purchaseDetails(BuildContext context) {
    AlertDialog alert = AlertDialog(
      ...
      content: Column(
        ...
        children: [
          ColTextWidget(
              titleText: "Client Name", subText: controller.clientName.value),
          RowTextWidget(
              titleText: "Product Name", subText: controller.productName.value),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              RowTextWidget(
          ...
          ColTextWidget(
              titleText: "Remarks", subText: controller.remarks.value),
        ],
      ),
    );
    showDialog(
