import 'package:business_cpu/app/modules/SelectItems/views/select_items_view.dart';
...
class AddQuoteView extends GetView<AddQuoteController> {
  AddQuoteView({Key? key}) : super(key: key);
  final AddQuoteController addQuoteController = Get.put(AddQuoteController());
