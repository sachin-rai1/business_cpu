...
class ViewCustomerView extends GetView<ViewCustomerController> {
  ViewCustomerView({Key? key}) : super(key: key);

 final ViewCustomerController viewCustomerController =
