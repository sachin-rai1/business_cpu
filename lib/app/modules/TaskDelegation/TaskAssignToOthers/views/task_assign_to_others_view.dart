...
class TaskAssignToOthersView extends GetView<TaskAssignToOthersController> {
  const TaskAssignToOthersView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Get.put(TaskAssignToOthersController());
    return Scaffold(
      body: Column(
        children: [
          Obx(
